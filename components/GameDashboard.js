...
export default function GameDashboard() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Header */}
      <div className="pt-10 text-center">
        <h1 className="text-3xl font-bold font-mono mb-2">CHALLENGE ARCHIVE</h1>
        <p className="text-gray-600">
          Explore all challenges from the REBOOT 2025
        </p>
      </div>
            ...
            >
              ...
              {!committee.levels && (
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => handleChallengeClick(committee)}
                    className="px-4 py-2 text-sm font-bold border-2 border-black bg-black text-white hover:bg-gray-800 transition-colors"
                  >
                    VIEW
                  </button>
                </div>
